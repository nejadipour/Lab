...
public class Notes
{
    ...
    public Notes()
    {
        ...
        this.dataPath = Paths.get(".\\src\\Byte\\data");
    ...
    public void addNote() throws IOException
    {
        ...
        FileWriter fileWriter = new FileWriter(dataPath + "\\" + title + ".txt");
    ...
    {
        FileReader fileReader = new FileReader(dataPath + "\\" + name + ".txt");
        int input;
